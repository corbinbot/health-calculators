...
if (isset($_POST['submit'])) {
    $response = water($_POST['name'], $_POST['mobile'], $_POST['email'], $_POST['weight'], $_POST['age'], $_POST['exe_time'], $_POST['interested']);
}
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="form-wrap">
                ...
                <form id="survey-form" action="water.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="age" id="email" placeholder="AGE IN YRS" class="form-control"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6">
