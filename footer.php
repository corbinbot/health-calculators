<footer id="Footer" style="background-color:#fff;" class="page-footer font-small stylish-color-dark pt-2 mt-4">
    ...
    font-size: 25px;">About Us</h6>
            ...
            <div class="col-md-4 mx-auto mt-3 mb-0 text-lg-end text-md-end text-sm-center text-center">
    ...
    <!-- Copyright -->
    <div style="background-color:#fff;" class="footer-copyright text-center py-2">
        <p>
    ...
    <div style="background-color:#fff;" class="footer-copyright text-center py-2">
        ...
        Design and Developed by | <a href="https://www.magcloudsolutions.in/">Mag Cloud Solutions Pvt. Ltd.</a>
    </div>
